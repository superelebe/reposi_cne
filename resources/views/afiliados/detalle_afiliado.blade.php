					...
					<tbody>
						<tr>
							<td>
								...
								<div id="subarea">{{$afiliado->servicios->nombre}}</div>
								...
								<div class="wrapper">
									...
									<div id="email">
										<a style="display:block;padding:5px 15px 5px 35px; position:absolute; font-size:16px; margin:0 30px" href="mailto:{{$afiliado->email}}">{{$afiliado->email}}</a>
										<br>
							...
							<td bgcolor="#455560">
								<form class="forma3" name="formafiliados" method="post" action="{{route('enviarCorreoAfiliado')}}">
									<input type="hidden" name="_token" value="{{ csrf_token() }}">
									<input name="emailemp" value="{{$afiliado->email}}" type="hidden">
